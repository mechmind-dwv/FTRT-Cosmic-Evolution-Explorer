...
graph TB
    ...
    subgraph "Planetary Interface"
        D[Geomagnetic Field]
        E[Atmospheric Shield]
    end
    
    subgraph "Biological Layer"
        F[DNA Mutation Engine]
        G[Viral Evolution]
        H[Organism Adaptation]
    end
    
    subgraph "Evolutionary Output"
        I[Speciation Events]
        J[Body Plan Innovation]
        K[Extinction/Radiation Cycles]
    end
